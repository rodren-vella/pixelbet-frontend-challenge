    ...
    if (
      ...
      if (req.body.username === user.username) {
        ...
        if (user.balance >= req.body.betAmount) {
          ...
          responseBody = {
            errors:
              "Insufficient funds in your balance to place " +
              user.currency +
              " " +
              req.body.betAmount,
          };
      ...
      responseBody = {
        errors:
          "Some of the parameters provided are not defined. Make sure you post the following params : username : string, betAmount : number and sideSelected : number from 1 to 6.",
      };
    }
